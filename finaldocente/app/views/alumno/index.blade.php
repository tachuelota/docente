...
<div class="well" style="background-image: url('images/fondogobierno.png');height:140px;background-repeat:no-repeat;"></div> 
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse">
           	<ul class="nav navbar-nav">
           		<li class="active"><a href="alumno/inicio" class="menu">Inicio</a></li>
           		<li><a href="alumno/miperfilindex" class="menualone menu">Mi Perfil</a></li>
           		
           		<li><a href="alumno/evaluacionindex" class="menu">Evaluación</a></li>
    ...
    $(function(){
       ...
       spinermini.stop();
    	 ...
    	 $("#contenidoprincipal").load(base_url+"alumno/inicio");
